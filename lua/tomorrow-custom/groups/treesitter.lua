...
function M.highlight(palette, opts)
    return {
        ...
        -- ["@keyword.conditional"] = vim.tbl_extend("force", { fg = palette.light_gray, bold = true }, opts.styles.conditionals),
        -- ["@keyword.coroutine"] = { fg = palette.gray_blue },
        -- ["@keyword.exception"] = { fg = palette.red },
        ["@keyword.function"] = vim.tbl_extend("force", { fg = palette.white, italic = true }, opts.styles.keywords),
        ...
        ["@type.builtin"] = { fg = palette.lighter_gray, bold = true },
