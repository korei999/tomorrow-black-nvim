...
function M.highlight(palette, opts)
    return {
        Normal = { fg = palette.fg, bg = opts.transparent and palette.none or palette.bg, },
        SignColumn = { bg = opts.transparent and palette.none or palette.bg },
        MsgArea = { fg = palette.fg, bg = opts.transparent and palette.none or palette.bg, },
        ...
        NormalNC = { fg = palette.fg, bg = opts.transparent and palette.none or palette.bg, },
        ...
        Comment = vim.tbl_extend("force", { fg = palette.medium_gray, italic = true }, opts.styles.comments),
        ...
        NormalFloat = { bg = opts.transparent and palette.none or palette.alt_bg, },
        ...
        TermCursor = { fg = palette.cursor_fg, bg = palette.cursor_bg, reverse = false, },
        TermCursorNC = { fg = palette.alt_bg, reverse = false, },
        ...
        Type = vim.tbl_extend("force", { fg = palette.lighter_gray, bold = true }, opts.styles.type),
        StorageClass = { fg = palette.lighter_gray, bold = true },
        Structure = vim.tbl_extend("force", { fg = palette.lighter_gray, bold = true, italic = true }, opts.styles.structures),
        Typedef = { fg = palette.blue },
        Keyword = vim.tbl_extend("force", { fg = palette.lighter_gray, bold = true }, opts.styles.keywords),
        Statement = { fg = palette.light_gray, bold = true },
        Conditional = vim.tbl_extend("force", { fg = palette.lighter_gray, bold = true }, opts.styles.conditionals),
        Repeat = vim.tbl_extend("force", { fg = palette.light_gray, bold = true }, opts.styles.loops),
        Label = { fg = palette.white },
        Exception = { fg = palette.light_gray, bold = true },
        Include = { fg = palette.blue },
        PreProc = { fg = palette.light_gray, bold = true },
        Define = { fg = palette.light_gray, bold = true },
        Macro = { fg = palette.light_gray, bold = true },
